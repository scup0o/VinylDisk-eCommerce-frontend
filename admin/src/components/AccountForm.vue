        ...
        if (this.edit === false) {
          if (this.accountNew.password === null) {
            ...
            if (this.accountNew.password.length < 6) {
              ...
              const check = await StaffService.create(data);
              if (check === false) {
          ...
          if (
            ...
            console.log('a')}
                ...
                const check = await StaffService.update(this.accountNew._id, data);
            console.log(check)
            if (check === false) {
            ...
            if (
              this.accountNew._id === this.staff.id &&
              (this.accountNew.role != this.staff.role ||
                this.accountNew.staffId != this.staff.username)
            ) {
              UserService.logout();

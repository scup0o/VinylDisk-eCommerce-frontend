...
<template>
    <div class="container-fluid" style="background-image: url('../assets/img/vinyl-login.jpg');">
            <div class="row">
                    ...
                    <div style="padding:50px; padding-top:150px">
                        ...
                        <Form
                            ...
                            <div class="form-group">
                                <label for="userLog" style="font-family: 'RalewayBold';">Mã nhân viên</label>
                                <Field
                                    name="userLog"
                                    type="text"
                                    class="form-control"
        ...
        methods: {
            async loginUser(data){
                try{
                    ...
                    console.log(user);
                    if(user === 'incorrected'){
                        if (user === 'incorrected') alert("Mã nhân viên hoặc mật khẩu sai");
